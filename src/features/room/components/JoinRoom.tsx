  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm bg-surface border border-border rounded-xl p-10 animate-fade-in">
        <button
          onClick={onBack}
          className="text-xs text-muted hover:text-white mb-6 block transition-colors"
        >
          ← Voltar
        </button>
        ...
        <div className="flex flex-col gap-4">
          <input
            className="w-full px-4 py-3 bg-surface2 border border-border rounded-lg text-white text-sm
              outline-none focus:border-primary transition-colors tracking-widest uppercase text-center font-bold"
            placeholder="CÓDIGO"
            value={code}
            maxLength={6}
